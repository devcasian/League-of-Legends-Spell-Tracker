...
SLOT_SPACING_MAX = 20
SLOT_SPACING_STEP = 1
DEFAULT_SLOT_SPACING = 2

DEFAULT_POSITION = {'x': 848, 'y': 730}
DEFAULT_LOCKED = False

AUTO_LOAD_ENABLED = True
AUTO_LOAD_POLL_INTERVAL = 3.0

AUTO_LOAD_INDICATOR_SIZE = 10
AUTO_LOAD_INDICATOR_COLOR_INACTIVE = "#555555"
AUTO_LOAD_INDICATOR_COLOR_ACTIVE = "#27ae60"

SHOW_CHAMPION_NAMES = False

GRAY_LOW_LEVEL_ICONS = True
